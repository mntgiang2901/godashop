...
import { authNonAxiosInstance, getCategoryId, updateParam } from '../helper/util';
...
export default function Product() {
    ...
    const getProducts = async () => {
        ...
        try {
            ...
            const response = await authNonAxiosInstance().get(`/products?item_per_page=10&category_id=${categoryId}&price-range=${priceRange}`)
