...
import CategoriedProductsList from '../component/CategoriedProductsList';
...
export default function Home() {
    ...
    const getFeaturedProducts = async () => {
        try {
            ...
            const response = await authNonAxiosInstance().get(`/products?featured=1&item_per_page=4`)
    ...
    const getLatestProducts = async () => {
        try {
            console.log(new Date());
            const response = await authNonAxiosInstance().get(`/products?latest=1&item_per_page=4`)
    ...
    const getCategoriedProducts = async () => {
        try {
            console.log(new Date());
            const response = await authNonAxiosInstance().get(`/products?hierarchy=1&item_per_page=4`)
            ...
            <div>
                ...
                <main id="maincontent" className="page-main">
                    <div className="container">
                        ...
                        {
                            isCategoriedLoaded ? <CategoriedProductsList categoriedProducts={categoriedProducts} /> : <Loading />
                        }
                    </div>
                </main>
            </div>
