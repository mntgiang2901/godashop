...
export default function Header() {
    ...
    //Đăng ký store về thay đổi trạng thái đăng nhập/đăng xuất
                ...
                <header>
                    ...
                    <div className="top-navbar container-fluid">
                        <div className="menu-mb">
                            <NavLink to="#" className="btn-close" onclick="closeMenuMobile()">×</NavLink>
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-6 hidden-sm hidden-xs">
                                <ul className="list-inline">
                                    <li><Link to="https://www.facebook.com/giang.mai.526/"><i className="fab fa-facebook-f" /></Link></li>
                            ...
                            <div className="col-md-6 col-sm-10 col-xs-11">
                                <ul className="list-inline pull-right top-right">
                                    <li className="account-login">
                                        {
                                            isLogin ? <Link to="/don-hang-cua-toi.html" class="btn-logout">Đơn hàng của tôi</Link> : <Link to="#" onClick={() => handlePopupRegister()} className="btn-register">Đăng Ký</Link>
                                        }
                    ...
                    <div className="container">
                        <div className="row">
                            ...
                            <div className="col-lg-4 col-md-4 col-sm-12 col-xs-12 logo">
                                <Link to="#"><img src="../images/goda450x170_1.jpg" alt='' className="img-responsive" /></Link>
                            </div>
                            <div className="col-lg-4 col-md-4 hidden-sm hidden-xs call-action">
                                <Link to="#"><img src="../images/godakeben450x170.jpg" alt='' className="img-responsive" /></Link>
                            </div>
                            {/* HOTLINE AND SERCH */}
                            <div className="col-lg-4 col-md-4 hotline-search">
                                <div>
                                    <p className="hotline-phone"><span><strong>Hotline: </strong><Link to="tel:0903.022.901">0903.022.901</Link></span></p>
                                    <p className="hotline-email"><span><strong>Email: </strong><Link to="mailto:giangsodo2901@gmail.com">giangsodo2901@gmail.com</Link></span></p>
                                </div>
