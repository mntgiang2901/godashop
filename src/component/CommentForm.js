        ...
        <div>
            <form className="form-comment" action method="POST" onSubmit={formik.handleSubmit}>
                ...
                <div className="form-group">
                    ...
                    />
                    <input type="text" className="form-control" name="fullname" placeholder="Tên *" onChange={formik.handleChange}
                    ...
                    {formik.touched.email && formik.errors.email ?
                        ...
                        : null}
                    <textarea name="description" id="input" className="form-control" rows={3} placeholder="Nội dung *" onChange={formik.handleChange}
