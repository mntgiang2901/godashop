...
import { authNonAxiosInstance, authAxiosInstance } from '../helper/util';
...
export default function DeliveryInfo() {
    ...
    const getProvinces = async () => {
        try {
            const response = await authNonAxiosInstance().get(`/provinces`);
    ...
    const getDistricts = async (province_id) => {
        try {
            const response = await authNonAxiosInstance().get(`/districts/province/${province_id}`);
    ...
    const getWards = async (district_id) => {
        try {
            const response = await authNonAxiosInstance().get(`/wards/district/${district_id}`);
    ...
    const formik = useFormik({
        ...
        onSubmit: async values => {
            try {
                ...
                await authAxiosInstance().post(`/orders`, JSON.stringify(data));
                    ...
                    <div className="row">
                        ...
                        <div>
                            ...
                            <div className="form-group">
                                ...
                                <div className="bank-info">STK: 70903022901<br />Chủ TK: Mai Nguyễn Tuấn Giang. Ngân hàng: TPbank <br />
